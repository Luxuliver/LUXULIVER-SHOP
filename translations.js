const translations = {
    id: {
        ...
        footer_policy_title: 'Informasi dan Kebijakan',
        ...
        faq_a4: 'Saat ini kami menerima pembayaran melalui transfer bank (BCA, Mandiri) dan dompet digital (GoPay, OVO) dan lain-lain. Anda dapat memilih metode yang paling nyaman bagi Anda pada langkah checkout.',
        ...
        return_p3: '<strong>Batas Waktu:</strong> Klaim pengembalian harus diajukan maksimal 15 hari setelah barang diterima, dengan menyertakan video unboxing sebagai bukti.',
    ...
    toast_single_items_in_cart_warning: 'Keranjang Anda berisi produk satuan. Paket tidak dapat ditambahkan.',
        ...
        notif_promo_1_title:  'Belanja Lebih Banyak, Hemat Lebih Banyak!',
        notif_promo_1_desc_short: 'Diskon 5% untuk pembelian minimal 5 item.',
        notif_promo_1_desc_full: 'Jangan lewatkan penawaran spesial kami! Dapatkan diskon 5% secara otomatis untuk setiap pembelian minimal 5 produk satuan dalam satu transaksi. Promo ini berlaku untuk semua koleksi kecuali item bundel dan tidak dapat digabungkan dengan promo lainnya. Diskon akan langsung terpotong di keranjang belanja Anda.',
        notif_info_1_title: 'Jadwal Pengiriman Rutin',
        notif_info_1_desc_short: 'Komitmen kami mengirimkan pesanan secepatnya. Proses pengiriman berjalan setiap Senin-Sabtu.',
        notif_info_1_desc_full:  'Kami berkomitmen mengirimkan pesanan Anda secepatnya. Proses pengiriman berjalan setiap hari Senin hingga Sabtu. Pesanan yang terkonfirmasi sebelum jam 14:00 WIB akan diproses dan diserahkan ke kurir pada hari yang sama. Pesanan setelah jam tersebut akan dikirim pada hari kerja berikutnya. Hari Minggu dan tanggal merah tidak ada pengiriman.',
        notif_info_2_title: 'Koleksi Classy Terbaru Telah Hadir!',
        notif_info_2_desc_short: 'Koleksi T-shirt "Vanderlux" dengan desain Classy yang elegan kini tersedia. Jelajahi sekarang!',
        notif_info_2_desc_full: 'Telah tiba! Koleksi T-shirt "Vanderlux" dengan desain Classy yang elegan kini tersedia. Mengusung tema kemewahan minimalis, koleksi ini dibuat dengan bahan premium dan detail sablon yang presisi. Jelajahi sekarang di halaman koleksi dan jadilah yang pertama memilikinya. Stok terbatas.',
        notif_promo_2_title:'Potongan Ongkir Khusus Jabodetabek!',
        notif_promo_2_desc_short:'Nikmati potongan biaya pengiriman untuk setiap pesanan di area Jabodetabek. Belanja lebih hemat!',
        notif_promo_2_desc_full: 'Kabar baik untuk Anda di area Jabodetabek! Nikmati potongan biaya pengiriman sebesar Rp1000 untuk setiap pesanan. Belanja lebih hemat dan nyaman langsung ke depan pintu Anda. Potongan akan diaplikasikan secara otomatis oleh admin saat konfirmasi pesanan via WhatsApp.',
        notif_info_3_title: 'Pembaruan Fitur: Perbandingan Produk',
        notif_info_3_desc_short: 'Bingung memilih? Kini Anda bisa menggunakan fitur "Bandingkan" untuk melihat detail dua produk.',
        notif_info_3_desc_full: 'Kami baru saja meluncurkan fitur baru untuk membantu Anda! Kini Anda bisa memilih hingga 2 produk dan mengklik tombol "Bandingkan" untuk melihat spesifikasi, harga, dan rating keduanya secara berdampingan. Temukan pilihan yang paling tepat untuk gaya Anda dengan lebih mudah.',
        notif_promo_3_title: 'Promo Bulan November: Waktunya Upgrade Gaya!',
        notif_promo_3_desc_short: 'Rayakan bulan November dengan harga promo dari kami! Nikmati penawaran spesial untuk produk di koleksi kami.',
        notif_promo_3_desc_full: 'Waktunya upgrade gaya Anda! Rayakan bulan November nanti dengan penawaran spesial dari kami. Nikmati diskon hingga 6% untuk semua produk yang ada di koleksi. Promo berlaku selama 2 hari. Ini adalah saat yang tepat untuk memanjakan diri dengan koleksi terbaru.',
        notif_info_4_title: 'Metode Pembayaran Baru Telah Tersedia',
        notif_info_4_desc_short: 'Untuk kemudahan Anda, kini kami menerima pembayaran melalui DANA dan ShopeePay.',
        notif_info_4_desc_full: 'Kami selalu berusaha memberikan kemudahan untuk Anda. Dengan senang hati kami mengumumkan bahwa kini kami secara resmi menerima metode pembayaran baru melalui dompet digital DANA dan ShopeePay, melengkapi pilihan yang sudah ada. Pilihan bertransaksi semakin lengkap dan mudah!',
        notif_promo_4_title: 'Kaos gratis untuk pembeli!',
        notif_promo_4_desc_short: 'Beli 20 kaos, gratis 1 kaos pilihan tertentu.',
        notif_promo_4_desc_full: 'Nikmati penawaran kaos gratis! Beli 20 kaos dari koleksi dan dapatkan 1 kaos gratis. Cocok untuk isi lemari dengan gaya fresh setiap hari.',
        notif_info_5_title: 'Artikel Baru: Panduan Merawat Kaos Putih',
        notif_info_5_desc_short: 'Kaos putih Anda menguning? Temukan tips dan trik profesional di artikel terbaru kami.',
        notif_info_5_desc_full: 'Kaos putih adalah item fashion esensial, namun merawatnya butuh perhatian khusus. Kaos putih Anda mulai menguning atau kusam? Temukan tips dan trik profesional untuk mencuci, menghilangkan noda, dan menjaga agar kaos putih Anda tetap cerah seperti baru di artikel terbaru kami di halaman Blog.',
        notif_promo_5_title: 'Potongan Ongkir Khusus Surabaya!', 
        notif_promo_5_desc_short: 'Nikmati potongan ongkir Rp3.000 untuk setiap pesanan area Surabaya.', 
        notif_promo_5_desc_full: 'Kabar gembira untuk Anda yang berdomisili di Surabaya! Setiap pesanan akan mendapatkan potongan ongkir sebesar Rp3.000. Promo ini berlaku otomatis saat pesanan diproses oleh admin via WhatsApp. Belanja jadi lebih hemat dan nyaman.', 
        notif_info_6_title: 'Testimoni Pelanggan: Koleksi Favorit',
        notif_info_6_desc_short: 'Lihat cerita nyata dari pelanggan setia Luxuliver.',
        notif_info_6_desc_full: 'Kami bangga mendengar cerita dari pelanggan. Simak pengalaman mereka menggunakan kaos Luxuliver, dari kualitas bahan hingga kenyamanan dipakai seharian.',
        notif_promo_6_title: 'Potongan Ongkir Khusus Denpasar!', 
        notif_promo_6_desc_short: 'Nikmati potongan ongkir Rp4.000 untuk setiap pesanan area Denpasar.', 
        notif_promo_6_desc_full: 'Kabar baik untuk Anda di Denpasar! Kini setiap pesanan akan mendapatkan potongan ongkir sebesar Rp4.000. Promo ini berlaku otomatis saat pesanan dikonfirmasi admin via WhatsApp. Belanja jadi lebih hemat dan sampai langsung ke depan pintu rumah Anda.', 
        notif_info_7_title: 'Restock & Rilis: Koleksi Velluto.',
        notif_info_7_desc_short: 'Koleksi elegan "Velluto" kini resmi dirilis dengan desain classy.', 
        notif_info_7_desc_full: 'Setelah dinantikan, koleksi "Velluto" akhirnya rilis! Terinspirasi dari beludru dan seni klasik Italia, koleksi ini hadir dengan potongan desain modern dan bahan premium yang nyaman. Cocok untuk Anda yang suka gaya classy dengan sentuhan mewah.',
        notif_promo_7_title: 'Potongan Ongkir Khusus Bandung!', 
        notif_promo_7_desc_short: 'Pesanan area Bandung hemat ongkir Rp2.000.', 
        notif_promo_7_desc_full: 'Kabar gembira untuk Anda di Bandung! Nikmati potongan ongkir sebesar Rp2.000 untuk setiap pesanan. Promo ini berlaku otomatis saat pesanan dikonfirmasi admin via WhatsApp. Belanja jadi lebih hemat dan nyaman.', 
        ...
        specs_title: 'Spesifikasi dan Kualitas Produk',
        ...
        blog_modal_title: 'Blog dan Artikel Edukasi',
        ...
        article3_content: {
            ...
            p5: 'Apakah Anda suka kaos yang pas di badan (Regular fit) atau sedikit longgar (regular/oversized)? Jika Anda berada di antara dua ukuran, pilihlah ukuran yang lebih kecil untuk tampilan fit, atau ukuran yang lebih besar untuk tampilan yang lebih santai.',
    ...
    nav_history: 'History',
    sidebar_title: 'Menu and Filters',
    ...
    footer_social_text: '<a href="https://www.instagram.com/luxuliver" target="_blank" rel="noopener noreferrer">luxuliver</a>',
    footer_policy_title: 'Information and Policies',
    ...
    faq_a4: 'We currently accept payments via bank transfer (BCA, Mandiri) and digital wallets (GoPay, OVO) and others. You can choose the most convenient method for you at the checkout step.', 
    ...
    return_p3: '<strong>Timeframe:</strong> Return claims must be submitted a maximum of 15 days after the item is received, accompanied by an unboxing video as proof.',
    ...
    specs_title: 'Product Specifications and Quality',
    ...
    blog_modal_title: 'Blog and Educational Articles',
    ...
    article3_content: {
        ...
        p5: 'Do you prefer a t-shirt that is snug (Regular fit) or a bit looser (regular/oversized)? If you are between two sizes, choose the smaller size for a fitted look, or the larger size for a more relaxed look.',
