document.addEventListener('DOMContentLoaded', () => {
    ...
    id: {
        ...
        sidebar_product_options: 'Pilihan Produk',
        sidebar_availability: 'Ketersediaan',
        sidebar_filter_ready: 'Ready Stock',
        sidebar_filter_preorder: 'Pre-Order',
        sidebar_color: 'Warna',
        color_black: 'Hitam',
        color_white: 'Putih',
        ...
        sidebar_visual_settings: 'Pengaturan Visual',
        sidebar_accessibility: 'Aksesibilitas',
        ...
        logout: 'Logout',
        logout_confirm: 'Semua data sesi Anda (Keranjang, Favorit, Riwayat Pesanan) akan dihapus dari peramban ini. Yakin ingin logout?',
        ...
        shipping_cost: 'Biaya',
        shipping_cost_value: 'Konfirmasi Admin',
        ...
        trust_badge_payment: 'Pembayaran Aman',
        trust_badge_quality: 'Garansi Kualitas',
        trust_badge_shipping: 'Pengiriman Cepat',
        ...
        empty_all_reviews: 'Belum ada ulasan yang diberikan.',
        history_track_order: 'Lacak Pesanan',
        history_buy_again: 'Beli Lagi',
        history_request_return: 'Ajukan Pengembalian',
        history_order: 'Pesanan',
        history_date: 'Tanggal',
        history_status_completed: 'Selesai',
        history_return_expired: 'Batas Pengembalian Habis',
        history_return_requested: 'Permintaan Terkirim',
        ...
        size_guide_note: '*Toleransi ukuran +/- 1-2 cm karena proses produksi.',
        video_gallery_title: 'Video Sinematik Koleksi',
        ...
        toast_comparison_cleared: 'Daftar perbandingan dibersihkan.',
        live_chat_title: 'Live Chat Support',
        faq_tab: 'FAQ',
        admin_tab: 'Hubungi Admin',
        faq_search_placeholder: 'Cari pertanyaan...',
        faq_q1_title: 'Bagaimana cara memesan produk?',
        faq_q1_answer: 'Untuk memesan, cukup tambahkan produk ke keranjang, lanjutkan ke checkout, isi informasi Anda, lalu klik tombol \'Buat Pesanan via WhatsApp\'. Anda akan diarahkan ke WhatsApp dengan pesan otomatis yang sudah kami siapkan untuk menyelesaikan pesanan dengan admin kami.',
        faq_q2_title: 'Terbuat dari bahan apa T-shirt ini?',
        faq_q2_answer: 'Semua T-shirt kami terbuat dari bahan katun premium berkualitas tinggi yang lembut, adem, dan nyaman dipakai sepanjang hari. Kami menjamin kualitas bahan dan sablon terbaik.',
        faq_q3_title: 'Bagaimana cara menentukan ukuran yang pas?',
        faq_q3_answer: 'Kami menyediakan \'Panduan Ukuran\' detail di setiap halaman produk. Cukup klik tombol \'Panduan Ukuran\' untuk melihat tabel ukuran lengkap (panjang, lebar, dan panjang lengan) dalam centimeter untuk membantu Anda memilih ukuran yang paling tepat.',
        faq_q4_title: 'Apa saja metode pembayaran yang tersedia?',
        faq_q4_answer: 'Saat ini kami menerima pembayaran melalui transfer bank (BCA, Mandiri) dan dompet digital (GoPay, OVO). Anda dapat memilih metode yang paling nyaman bagi Anda pada langkah checkout.',
        faq_q5_title: 'Berapa lama proses pengiriman?',
        faq_q5_answer: 'Estimasi waktu pengiriman tergantung pada lokasi Anda dan ekspedisi yang dipilih. Untuk area Jabodetabek, biasanya memakan waktu 1-3 hari kerja. Untuk luar Jabodetabek, estimasi 3-7 hari kerja. Nomor resi akan kami informasikan melalui WhatsApp setelah pesanan dikirim.',
        faq_q6_title: 'Bagaimana kebijakan pengembalian barang?',
        faq_q6_answer: 'Kami menerima pengembalian produk jika ada cacat produksi atau kesalahan pengiriman dari pihak kami. Klaim harus diajukan maksimal 3 hari setelah barang diterima dengan menyertakan video unboxing. Produk akan diganti dengan yang baru, kami tidak melayani refund.',
        faq_not_found_q: 'Tidak menemukan jawaban yang Anda cari?',
        faq_not_found_btn: 'Hubungi Admin',
        a11y_panel_title: 'Pengaturan Tampilan & Aksesibilitas',
        a11y_font_size: 'Ukuran Teks',
        a11y_readable_font: 'Teks Mudah Dibaca',
        a11y_high_contrast: 'Kontras Tinggi',
        a11y_underline_links: 'Garis Bawahi Tautan',
        a11y_reduce_motion: 'Kurangi Gerakan',
        a11y_reading_guide: 'Pemandu Baca',
        a11y_close: 'Tutup',
    },
    en: {
        ...
        sidebar_product_options: 'Product Options',
        ...
        sidebar_visual_settings: 'Visual Settings',
        ...
        follow_tiktok: 'TikTok',
        logout: 'Logout',
        logout_confirm: 'All your session data (Cart, Favorites, Order History) will be deleted from this browser. Are you sure you want to log out?',
        ...
        shipping_cost: 'Cost',
        shipping_cost_value: 'Confirm with Admin',
        ...
        trust_badge_payment: 'Secure Payment',
        trust_badge_quality: 'Quality Guarantee',
        trust_badge_shipping: 'Fast Shipping',
        ...
        empty_all_reviews: 'No reviews have been submitted yet.',
        history_track_order: 'Track Order',
        history_buy_again: 'Buy Again',
        history_request_return: 'Request Return',
        history_order: 'Order',
        history_date: 'Date',
        history_status_completed: 'Completed',
        history_return_expired: 'Return Period Expired',
        history_return_requested: 'Request Sent',
        ...
        th_width: 'Width',
        th_sleeve: 'Sleeve',
        size_guide_note: '*Size tolerance +/- 1-2 cm due to production process.',
        video_gallery_title: 'Cinematic Collection Videos',
        ...
        toast_comparison_cleared: 'Comparison list has been cleared.',
        live_chat_title: 'Live Chat Support',
        faq_tab: 'FAQ',
        admin_tab: 'Contact Admin',
        faq_search_placeholder: 'Search questions...',
        faq_q1_title: 'How do I place an order?',
        faq_q1_answer: 'To order, simply add products to your cart, proceed to checkout, fill in your information, and then click the \'Order via WhatsApp\' button. You will be redirected to WhatsApp with a pre-filled message to finalize the order with our admin.',
        faq_q2_title: 'What material are the T-shirts made of?',
        faq_q2_answer: 'All our T-shirts are made from high-quality premium cotton that is soft, cool, and comfortable for all-day wear. We guarantee the best quality for both materials and prints.',
        faq_q3_title: 'How do I find the right size?',
        faq_q3_answer: 'We provide a detailed \'Size Guide\' on each product page. Simply click the \'Size Guide\' button to see a complete size chart (length, width, and sleeve length) in centimeters to help you choose the most accurate size.',
        faq_q4_title: 'What payment methods are available?',
        faq_q4_answer: 'We currently accept payments via bank transfer (BCA, Mandiri) and digital wallets (GoPay, OVO). You can choose the most convenient method for you at the checkout step.',
        faq_q5_title: 'How long does shipping take?',
        faq_q5_answer: 'Shipping time estimates depend on your location and the chosen courier. For the Jabodetabek area, it usually takes 1-3 business days. For areas outside Jabodetabek, the estimate is 3-7 business days. We will provide the tracking number via WhatsApp once the order is shipped.',
        faq_q6_title: 'What is the return policy?',
        faq_q6_answer: 'We accept product returns if there is a manufacturing defect or a shipping error on our part. Claims must be submitted a maximum of 3 days after the item is received, accompanied by an unboxing video. The product will be replaced with a new one; we do not offer refunds.',
        faq_not_found_q: 'Didn\'t find the answer you were looking for?',
        faq_not_found_btn: 'Contact Admin',
        a11y_panel_title: 'Display & Accessibility Settings',
        ...
        a11y_reading_guide: 'Reading Guide',
        a11y_close: 'Close',
    }
};
